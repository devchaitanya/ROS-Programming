...
def talker():
    ...
    rospy.init_node('publisher2_node', anonymous=True)
    # Create a publisher object that will publish to the 'CSE2034' topic
    ...
    while not rospy.is_shutdown():
        ...
        # Publish the message string to the 'CSE2034' topic
        pub.publish(_string)
